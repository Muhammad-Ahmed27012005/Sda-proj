...
type AutocompleteResult = {
    ...
    tmdb_type?: 'movie' | 'tv';
    /**
     * Poster (titles) or headshot (people). May point to a third-party host. Watchmode does not grant any license to the underlying image.
     */
...
type TitleDetails = {
     ...
     */
    similar_titles?: Array<number> | null;
    /**
     * Network IDs (for TV)
     */
     ...
     */
    network_names?: Array<string> | null;
    /**
...
type GetTitleReleaseDatesAdvancedData = {
    body?: never;
    path?: never;
    query?: {
        /**
...
type GetTitleReleaseDatesAdvancedErrors = {
    /**
     * Unauthorized or free plan
     */
    401: _Error;
};
type GetTitleReleaseDatesAdvancedError = GetTitleReleaseDatesAdvancedErrors[keyof GetTitleReleaseDatesAdvancedErrors];
type GetTitleReleaseDatesAdvancedResponses = {
    /**
     * List of upcoming release dates
     */
    200: Array<TitleReleaseDate>;
};
type GetTitleReleaseDatesAdvancedResponse = GetTitleReleaseDatesAdvancedResponses[keyof GetTitleReleaseDatesAdvancedResponses];
 ...
 * Title type options
 */
type TitleType = 'movie' | 'tv_series' | 'tv_movie' | 'tv_special' | 'tv_miniseries' | 'short_film';
/**
 * Source type options
 */
...
declare class ReleasesApi {
    ...
    /**
     * Backwards-compatible alias for `getReleaseDates()`
     */
    getUpcoming(options?: {
        startDate?: number;
        endDate?: number;
