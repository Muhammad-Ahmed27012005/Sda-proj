...
var getTitleReleaseDatesAdvanced = (options) => (options?.client ?? client).get({
  security: [{ name: "X-API-Key", type: "apiKey" }],
  ...
  constructor(config) {
    this.client = createClient(
      createConfig({
        ...
        fetch: config.fetch,
        // The generated client sends this value in the X-API-Key header.
        auth: config.apiKey
      })
    );
...
var ReleasesApi = class {
  ...
  getReleaseDates(options) {
    return getTitleReleaseDatesAdvanced({
      client: this.client,
      query: {
        start_date: options?.startDate,
        end_date: options?.endDate,
   ...
   */
  getUpcoming(options) {
    return this.getReleaseDates(options);
  }
};
